...
(function () {
  var m = function ($, Foundation, Modernizr, undefined) {
    'use strict';
  ...
  if (typeof define === 'function' && define.amd) {
    define(['jquery', 'foundation', 'modernizr'], m);
  } else if (typeof Foundation !== 'undefined' && typeof jQuery !== 'undefined' && typeof Modernizr !== 'undefined') {
    m(jQuery, Foundation, Modernizr);
  }
}());
